...
<head>
    ...
    <title>Vendor Panel - G-22 Recess</title>
    <!-- Bootstrap 5 -->
        ...
        <nav class="sidebar py-3 px-3 d-flex flex-column">
            <div class="sidebar-heading mb-2">
                ...
                <a class="nav-link {{ request()->routeIs('vendor.dashboard') ? 'active' : '' }}"
                    href="{{ route('vendor.dashboard') }}"><i class="fas fa-chart-pie me-2"></i> Dashboard</a>
                <a class="nav-link {{ request()->routeIs('vendor.apply') ? 'active' : '' }}"
                    href="{{ route('vendor.apply') }}"><i class="fas fa-file-alt me-2"></i> Apply as Vendor</a>
                <a class="nav-link {{ request()->routeIs('vendor.status') ? 'active' : '' }}"
                    href="{{ route('vendor.status') }}"><i class="fas fa-info-circle me-2"></i> Application Status</a>
