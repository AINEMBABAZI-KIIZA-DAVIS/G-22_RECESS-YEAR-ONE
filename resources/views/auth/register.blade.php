        ...
        <form method="POST" action="{{ route('register') }}" class="mt-4">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input id="name" class="form-control ps-3" type="text" name="name" value="{{ old('name') }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input id="email" class="form-control ps-3" type="email" name="email" value="{{ old('email') }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input id="password" class="form-control ps-3" type="password" name="password"
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input id="password_confirmation" class="form-control ps-3" type="password"
            ...
            <div class="mb-4">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="role" id="role_supplier" value="supplier" {{ old('role') == 'supplier' ? 'checked' : (!old('role') ? 'checked' : '') }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="role" id="role_wholesaler" value="wholesaler"
                            {{ old('role') == 'wholesaler' ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label d-flex align-items-center" for="role_vendor">
                            <i class="bi bi-briefcase me-2"></i>
                            <div>
                                <div class="fw-semibold">Vendor</div>
                                <small class="text-muted">Apply to supply products/services</small>
                            </div>
                        </label>
                    </div>
                    <div class="form-check">
            ...
            <div class="form-check mb-4">
                ...
                <label class="form-check-label" for="terms">
                    I agree to the <a href="#" class="text-decoration-none" style="color: #e76f51;">Terms of Service</a>
                    and
            ...
            <button type="submit" class="btn btn-primary w-100 py-2 mb-3"
                style="background-color: #e76f51; border: none; font-weight: 600; letter-spacing: 0.5px;">
                {{ __('Create Account') }}
            </button>
        ...
        <div class="text-center mt-4">
            <div class="position-relative">
                ...
                <span class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted"
                    style="font-size: 0.9rem;">{{ __('Or sign up with') }}</span>
            </div>
