...
<body>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p>We source only the finest, freshest ingredients to ensure the highest quality in every bite.
                        </p>
                    </div>
                </div>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center py-4">
            ...
            <p class="lead mb-4">Join our community of happy customers and taste the Premium Bakery difference today.
            </p>
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright">
                &copy; {{ date('Y') }} Premium Bakery. All rights reserved.
            </div>
        </div>
    </footer>
