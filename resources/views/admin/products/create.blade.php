            ...
            <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('low_stock_threshold') is-invalid @enderror" id="low_stock_threshold" name="low_stock_threshold" value="{{ old('low_stock_threshold') }}" min="0">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary-gradient me-2">Save Product</button>
